...
class TpMainWindow : public QMainWindow
{
    ...
    friend class TpDialogCharacter;
    friend class TpDialogDocuments;
    friend class TpDialogGoto;
...
public:
    TpMainWindow(bool create = false, bool open = false, TpEditor *dropped = nullptr, QWidget *parent = nullptr);
    ~TpMainWindow();
...
private slots:
    ...
    void onAction_E_L_R(bool);
    void onAction_E_L_N(bool);
    void onAction_E_L_E(bool);
    void onAction_E_L_B(bool);
    void onAction_E_L_V(bool);
    void onAction_E_L_Z(bool);
    void onAction_E_W_T(bool);
    void onAction_E_W_L(bool);
    void onAction_E_W_B(bool);
    void onAction_E_W_S(bool);
    void onAction_E_W_P(bool);
    void onAction_E_W_A(bool);
    ...
    void onAction_I_A(bool);
    void onAction_I_B(bool);
    ...
    void onAction_O_C_U(bool);
    void onAction_O_C_L(bool);
    void onAction_O_C_T(bool);
    void onAction_O_C_S(bool);
    void onAction_O_C_I(bool);
    void onAction_O_C_R(bool);
    ...
    void onAction_T_P(bool);
    void onAction_T_R(bool);
    ...
    void onAction_T_B_I_B(bool isChecked);
    void onAction_T_B_I_N(bool isChecked);
    void onAction_T_B_I_S(bool isChecked);
    void onAction_T_B_D_B(bool isChecked);
    ...
    void onAction_W_S(bool isChecked);
    ...
    void onTabsListChanged(int length);
...
private:
    ...
    void updateDocumentsDialog();
    void updateSettingsPages();
...
private:
    TpDialogCharacter *m_dialogCharacter;
    TpDialogCommands *m_dialogCommands;
    TpDialogDocuments *m_dialogDocuments;
