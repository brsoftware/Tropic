...
typedef struct TpColorScheme
{
    ...
    QColor Comment = QColor(0x60, 0x99, 0x60);
    QColor CommentLine = QColor(0x60, 0x99, 0x60);
    QColor CommentDoc = QColor(0x50, 0x89, 0x50);
    QColor Number = QColor(0x9a, 0xe1, 0xd4);
    QColor Keyword = QColor(0x40, 0xbf, 0xa0);
    QColor DoubleQuotedString = QColor(0xff, 0x88, 0x55);
    QColor SingleQuotedString = QColor(0xf0, 0x77, 0x44);
    QColor UUID = QColor(0x80, 0x80, 0x80);
    QColor PreProcessor = QColor(0xcf, 0x90, 0xea);
    QColor Operator = QColor(0xb0, 0xb0, 0xb0);
    ...
    QColor GlobalClass = QColor(0x55, 0xdd, 0xff);
    QColor RawString = QColor(0xff, 0xaa, 0x66);
    ...
    QColor Type = QColor(0xff, 0xcc, 0x99);
    QColor PrimitiveType = QColor(0xdd, 0xaa, 0x77);
    QColor Warning = QColor(0xff, 0x66, 0x66);
