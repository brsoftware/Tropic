    ...
    : QMenuBar(parent)
{
    ...
    F_U = new TpGeneralAction(F, tr("Opened Doc&uments"), QKeySequence(CTRL | ALT | Key_Up), true);
    F->addSeparator();
    ...
    E_L->addSeparator();
    E_L_R = new TpGeneralAction(E_L, tr("&Remove Duplicated"));
    E_L_N = new TpGeneralAction(E_L, tr("Remove Co&nsecutively Duplicated"));
    E_L_E = new TpGeneralAction(E_L, tr("Remove &Empty"));
    E_L_B = new TpGeneralAction(E_L, tr("Remove &Blank"));
    E_L->addSeparator();
    E_L_V = new TpGeneralAction(E_L, tr("Re&verse Line Order"));
    E_L_Z = new TpGeneralAction(E_L, tr("Randomi&ze Lines"));
    E_W = new TpGeneralMenu(E, tr("&Whitespace Operations"));
    E_W_T = new TpGeneralAction(E_W, tr("Remove &Trailing Whitespaces"));
    E_W_L = new TpGeneralAction(E_W, tr("Remove &Leading Whitespaces"));
    E_W_B = new TpGeneralAction(E_W, tr("Remove &Both Whitespaces"));
    E_W->addSeparator();
    E_W_S = new TpGeneralAction(E_W, tr("Tabs To &Spaces"));
    E_W_P = new TpGeneralAction(E_W, tr("&Preceding Spaces To Tabs Only"));
    E_W_A = new TpGeneralAction(E_W, tr("&All Spaces To Tabs"));
    ...
    V_T->addSeparator();
    V_T_O = new TpGeneralAction(V_T, tr("F&ocus The Next Tab"), QKeySequence(CTRL | ALT | Key_Right), true);
    V_T_U = new TpGeneralAction(V_T, tr("Foc&us The Previous Tab"), QKeySequence(CTRL | ALT | Key_Left), true);
    ...
    V_L_M = new TpGeneralAction(V_L, tr("&Move To New View"), QKeySequence(CTRL | Key_F6));
    V_L_T = new TpGeneralAction(V_L, tr("Move &To Next View"), QKeySequence(CTRL | SHIFT | Key_F6));
    V_L->addSeparator();
    ...
    I->addSeparator();
    I_A = new TpGeneralAction(I, tr("Blank Line &Above"), QKeySequence(CTRL | ALT | Key_Return));
    I_B = new TpGeneralAction(I, tr("Blank Line &Below"), QKeySequence(CTRL | SHIFT | ALT | Key_Return));
    I->addSeparator();
    ...
    I->addSeparator();
    I_O = new TpGeneralAction(I, tr("&Other Special Characters..."));
    ...
    O_L_E = new TpGeneralMenu(O_L, tr("&E"));
    O_L_E_E = new TpGeneralAction(O_L_E, tr("&Erlang"), QKeySequence(), false, true, false);
    ...
    O_C = new TpGeneralMenu(O, tr("&Case Conversion"));
    O_C_U = new TpGeneralAction(O_C, tr("&Uppercase"));
    O_C_L = new TpGeneralAction(O_C, tr("&Lowercase"));
    O_C_T = new TpGeneralAction(O_C, tr("&Title-case"));
    O_C_S = new TpGeneralAction(O_C, tr("&Sentence-case"));
    O_C_I = new TpGeneralAction(O_C, tr("&Inverted-case"));
    O_C_R = new TpGeneralAction(O_C, tr("&Random-case"));
    O->addSeparator();
    ...
    T->addSeparator();
    T_R = new TpGeneralAction(T, tr("Sea&rch For Commands..."),
        isDarwin ? QKeySequence() : QKeySequence(CTRL | SHIFT | ALT | Key_Slash), true, false, false);
    T->addSeparator();
    ...
    T_B->addSeparator();
    T_B_I = new TpGeneralMenu(T_B, tr("Automatic &Insertions"));
    T_B_I_B = new TpGeneralAction(T_B_I, tr("&Brackets and Quotes"), QKeySequence(), false, true, false);
    T_B_I_N = new TpGeneralAction(T_B_I, tr("Braces on &Newlines"), QKeySequence(), false, true, false);
    T_B_I_S
        = new TpGeneralAction(T_B_I, tr("Brackets and Quotes Within &Selection"), QKeySequence(), false, true, false);
    T_B_D = new TpGeneralMenu(T_B, tr("Automatic &Deletions"));
    T_B_D_B = new TpGeneralAction(T_B_D, tr("&Brackets and Quotes"), QKeySequence(), false, true, false);
    ...
    // W_Q = new TpGeneralAction(W, tr("&Quick Viewer"), QKeySequence(), false, true, false);
    W->addSeparator();
    W_S = new TpGeneralAction(W, tr("&Status Bar"), QKeySequence(), true, true, false);
    ...
    ag_Languages = new TpGeneralActionGroup(this,
        {O_L_A_C, O_L_A_S, O_L_A_A, O_L_B_B, O_L_B_T, O_L_B_S, O_L_B_A, O_L_B_F, O_L_C_C, O_L_C_p, O_L_C_pl, O_L_C_s,
         O_L_C_M, O_L_C_O, O_L_C_S, O_L_D_D, O_L_D_I, O_L_E_E, O_L_F_F, O_L_F_7, O_L_H_H, O_L_H_T, O_L_I_I, O_L_I_H,
         O_L_J_J, O_L_J_S, O_L_J_O, O_L_L_T, O_L_L_L, O_L_M_F, O_L_M_D, O_L_M_M, O_L_M_L, O_L_N_N, O_L_O_O, O_L_P_P,
         O_L_P_E, O_L_P_H, O_L_P_O, O_L_P_S, O_L_P_V, O_L_P_R, O_L_P_2, O_L_P_3, O_L_P_X, O_L_Q_Q, O_L_Q_S, O_L_R_R,
         O_L_S_S, O_L_S_Q, O_L_S_R, O_L_T_T, O_L_T_H, O_L_T_X, O_L_V_V, O_L_V_H, O_L_X_X, O_L_Y_Y, O_L_p, O_L_G_G,
         O_L_Q_U}
    );
