...
signals:
    ...
    void tabChanged(TP_NAMESPACE_NAME::TpTabWidget *tab, int index);
    void tabCloseRequested(TP_NAMESPACE_NAME::TpTabWidget *tab, int index);
...
private slots:
    ...
    void onApplicationFocusChanged(QWidget *oldWidget, QWidget *newWidget);

private:
    TpStackedWidget *m_parent;
    QList<TpTabWidget*> m_tabs;
    TpTabWidget *m_currentFocus;
};
